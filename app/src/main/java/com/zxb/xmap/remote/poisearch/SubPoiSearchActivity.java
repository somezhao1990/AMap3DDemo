...
private AutoCompleteTextView mKeywordText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zxb.xmap.remote.R.layout.subpoisearch_activity);
        mPoiSearchList = (ListView)findViewById(com.zxb.xmap.remote.R.id.listView);
        mKeywordText = (AutoCompleteTextView)findViewById(com.zxb.xmap.remote.R.id.keyword);
        mKeywordText.addTextChangedListener(this);
        mSearchbtn = (Button)findViewById(com.zxb.xmap.remote.R.id.search_btn);
