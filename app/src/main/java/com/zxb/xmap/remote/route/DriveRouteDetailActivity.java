...
public class DriveRouteDetailActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.activity_route_detail);
	...
	private void init() {
		mTitle = (TextView) findViewById(com.zxb.xmap.remote.R.id.title_center);
		mTitleDriveRoute = (TextView) findViewById(com.zxb.xmap.remote.R.id.firstline);
		mDesDriveRoute = (TextView) findViewById(com.zxb.xmap.remote.R.id.secondline);
	...
	private void configureListView() {
		mDriveSegmentList = (ListView) findViewById(com.zxb.xmap.remote.R.id.bus_segment_list);
