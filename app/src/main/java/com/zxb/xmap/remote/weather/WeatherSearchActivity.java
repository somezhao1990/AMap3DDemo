package com.zxb.xmap.remote.weather;
...
public class WeatherSearchActivity extends Activity implements OnWeatherSearchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zxb.xmap.remote.R.layout.weather_activity);
        init();
        searchliveweather();
    ...
    private void init() {
        TextView city = (TextView) findViewById(com.zxb.xmap.remote.R.id.city);
        city.setText(cityname);
        forecasttv = (TextView) findViewById(com.zxb.xmap.remote.R.id.forecast);
        reporttime1 = (TextView) findViewById(com.zxb.xmap.remote.R.id.reporttime1);
        reporttime2 = (TextView) findViewById(com.zxb.xmap.remote.R.id.reporttime2);
        weather = (TextView) findViewById(com.zxb.xmap.remote.R.id.weather);
        Temperature = (TextView) findViewById(com.zxb.xmap.remote.R.id.temp);
        wind = (TextView) findViewById(com.zxb.xmap.remote.R.id.wind);
        humidity = (TextView) findViewById(com.zxb.xmap.remote.R.id.humidity);
    }
    ...
    public void onWeatherLiveSearched(LocalWeatherLiveResult weatherLiveResult, int rCode) {
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (weatherLiveResult != null && weatherLiveResult.getLiveResult() != null) {
                ...
                ToastUtil.show(WeatherSearchActivity.this, com.zxb.xmap.remote.R.string.no_result);
            }
        } else {
