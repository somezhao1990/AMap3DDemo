package com.zxb.xmap.remote.overlay;
...
import com.zxb.xmap.remote.util.ToastUtil;
...
public class CustomMarkerActivity extends Activity implements OnMarkerClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.custommarker_activity);
		/*
		...
		mapView = (MapView) findViewById(com.zxb.xmap.remote.R.id.map);
	 ...
	 */
	private void init() {
		markerText = (TextView) findViewById(com.zxb.xmap.remote.R.id.mark_listenter_text);
		radioOption = (RadioGroup) findViewById(com.zxb.xmap.remote.R.id.custom_info_window_options);
		Button clearMap = (Button) findViewById(com.zxb.xmap.remote.R.id.clearMap);
		clearMap.setOnClickListener(this);
		Button resetMap = (Button) findViewById(com.zxb.xmap.remote.R.id.resetMap);
	...
	private void addMarkersToMap() {
		...
		// .fromResource(R.drawable.location_marker)
				BitmapDescriptorFactory.fromBitmap(BitmapFactory
						.decodeResource(getResources(),
								com.zxb.xmap.remote.R.drawable.location_marker)));
		...
		marker3 = aMap.addMarker(new MarkerOptions().position(
				...
				BitmapDescriptorFactory.fromResource(com.zxb.xmap.remote.R.drawable.ic_launcher)));
	}
	...
	public View getInfoContents(Marker marker) {
		if (radioOption.getCheckedRadioButtonId() != com.zxb.xmap.remote.R.id.custom_info_contents) {
			return null;
		}
		View infoContent = getLayoutInflater().inflate(
				com.zxb.xmap.remote.R.layout.custom_info_contents, null);
	...
	public View getInfoWindow(Marker marker) {
		if (radioOption.getCheckedRadioButtonId() != com.zxb.xmap.remote.R.id.custom_info_window) {
			return null;
		}
		View infoWindow = getLayoutInflater().inflate(
				com.zxb.xmap.remote.R.layout.custom_info_window, null);
	...
	public void render(Marker marker, View view) {
		if (radioOption.getCheckedRadioButtonId() == com.zxb.xmap.remote.R.id.custom_info_contents) {
			((ImageView) view.findViewById(com.zxb.xmap.remote.R.id.badge))
					.setImageResource(com.zxb.xmap.remote.R.drawable.badge_sa);
		} else if (radioOption.getCheckedRadioButtonId() == com.zxb.xmap.remote.R.id.custom_info_window) {
			ImageView imageView = (ImageView) view.findViewById(com.zxb.xmap.remote.R.id.badge);
			imageView.setImageResource(com.zxb.xmap.remote.R.drawable.badge_wa);
		}
		String title = marker.getTitle();
		TextView titleUi = ((TextView) view.findViewById(com.zxb.xmap.remote.R.id.title));
		if (title != null) {
		...
		TextView snippetUi = ((TextView) view.findViewById(com.zxb.xmap.remote.R.id.snippet));
		if (snippet != null) {
	...
	public void onClick(View v) {
		 ...
		 * 清空地图上所有已经标注的marker
		 */
		case com.zxb.xmap.remote.R.id.clearMap:
			if (aMap != null) {
				aMap.clear();
			}
			break;
		 ...
		 * 重新标注所有的marker
		 */
		case com.zxb.xmap.remote.R.id.resetMap:
			if (aMap != null) {
				aMap.clear();
				addMarkersToMap();
			}
