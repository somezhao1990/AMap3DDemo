	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = (RelativeLayout) RelativeLayout.inflate(
					mContext, com.zxb.xmap.remote.R.layout.offlinemap_group, null);
		}
		group_text = (TextView) convertView.findViewById(com.zxb.xmap.remote.R.id.group_text);
		group_image = (ImageView) convertView
				.findViewById(com.zxb.xmap.remote.R.id.group_image);
		...
		if (isOpen[groupPosition]) {
			group_image.setImageDrawable(mContext.getResources().getDrawable(
					com.zxb.xmap.remote.R.drawable.downarrow));
		} else {
			group_image.setImageDrawable(mContext.getResources().getDrawable(
					com.zxb.xmap.remote.R.drawable.rightarrow));
		}
		return convertView;
	}
