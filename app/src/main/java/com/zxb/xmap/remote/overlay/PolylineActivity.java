        ...
        OnSeekBarChangeListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(com.zxb.xmap.remote.R.layout.polyline_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
    ...
    private void init()
    {
        mColorBar = (SeekBar) findViewById(com.zxb.xmap.remote.R.id.hueSeekBar);
        mColorBar.setMax(HUE_MAX);
        mColorBar.setProgress(50);

        mAlphaBar = (SeekBar) findViewById(com.zxb.xmap.remote.R.id.alphaSeekBar);
        mAlphaBar.setMax(ALPHA_MAX);
        mAlphaBar.setProgress(255);

        mWidthBar = (SeekBar) findViewById(com.zxb.xmap.remote.R.id.widthSeekBar);
...
//		texTuresList.add(BitmapDescriptorFactory.fromResource(com.zxb.xmap.remote.R.drawable.custtexture));
//		texTuresList.add(BitmapDescriptorFactory.fromResource(com.zxb.xmap.remote.R.drawable.map_alr_night));
