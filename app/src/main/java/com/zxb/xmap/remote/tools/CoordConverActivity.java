...
public class CoordConverActivity extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.convert_activity);
		init();
	 ...
	 */
	private void init() {
		selectcoord = (Spinner)findViewById(com.zxb.xmap.remote.R.id.coord);
		latView = (EditText)findViewById(com.zxb.xmap.remote.R.id.pointLat);
		lngView = (EditText)findViewById(com.zxb.xmap.remote.R.id.pointLng);
		resultview = (TextView)findViewById(com.zxb.xmap.remote.R.id.result);
