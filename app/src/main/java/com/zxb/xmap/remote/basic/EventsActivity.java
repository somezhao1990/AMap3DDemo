...
public class EventsActivity extends Activity implements OnMapClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.events_activity);
		/*
	...
	private void init() {
		...
		mTapTextView = (TextView) findViewById(com.zxb.xmap.remote.R.id.tap_text);
		mCameraTextView = (TextView) findViewById(com.zxb.xmap.remote.R.id.camera_text);
		mTouchTextView = (TextView) findViewById(com.zxb.xmap.remote.R.id.touch_text);
	}
