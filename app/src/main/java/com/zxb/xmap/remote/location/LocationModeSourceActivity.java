package com.zxb.xmap.remote.location;
...
public class LocationModeSourceActivity extends Activity implements AMap.OnMyLocationChangeListener,OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.locationmodesource_activity);
	...
	private void init() {
		...
		mGPSModeGroup = (RadioGroup) findViewById(com.zxb.xmap.remote.R.id.gps_radio_group);
