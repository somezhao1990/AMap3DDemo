...
public class MinMaxZoomLevelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zxb.xmap.remote.R.layout.min_max_zoomlevel_activity);

        mapView = (MapView) findViewById(com.zxb.xmap.remote.R.id.map);
        mapView.onCreate(savedInstanceState);
        init();

        textMinZoomLevel = (EditText) findViewById(com.zxb.xmap.remote.R.id.text_min);
        textMaxZoomLevel = (EditText) findViewById(com.zxb.xmap.remote.R.id.text_max);
        textCurrentLevel = (TextView) findViewById(com.zxb.xmap.remote.R.id.text_current_level);
