package com.zxb.xmap.remote.district;
...
public class DistrictActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.district_activity);

		tv_countryInfo = (TextView) findViewById(com.zxb.xmap.remote.R.id.tv_countryInfo);
		tv_provinceInfo = (TextView) findViewById(com.zxb.xmap.remote.R.id.tv_provinceInfo);
		tv_cityInfo = (TextView) findViewById(com.zxb.xmap.remote.R.id.tv_cityInfo);
		tv_districtInfo = (TextView) findViewById(com.zxb.xmap.remote.R.id.tv_districtInfo);

		spinnerProvince = (Spinner) findViewById(com.zxb.xmap.remote.R.id.spinner_province);
		spinnerCity = (Spinner) findViewById(com.zxb.xmap.remote.R.id.spinner_city);
		spinnerDistrict = (Spinner) findViewById(com.zxb.xmap.remote.R.id.spinner_district);
