package com.zxb.xmap.remote.routepoi;
...
OnMarkerClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnRouteSearchListener, OnRoutePOISearchListener {
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.routepoi_activity);
	...
	private void init() {
		...
		gasbtn = (TextView)findViewById(com.zxb.xmap.remote.R.id.gasbtn);
		ATMbtn= (TextView)findViewById(com.zxb.xmap.remote.R.id.ATMbtn);
		Maibtn= (TextView)findViewById(com.zxb.xmap.remote.R.id.Maibtn);
		Toibtn= (TextView)findViewById(com.zxb.xmap.remote.R.id.Toibtn);
	}
		...
		if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
			if(result != null){
				...
				if (items != null && items.size() > 0) {
					...
					ToastUtil.show(RoutePOIActivity.this, com.zxb.xmap.remote.R.string.no_result);
				}
			}
		}else{
