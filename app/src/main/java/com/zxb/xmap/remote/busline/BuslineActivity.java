package com.zxb.xmap.remote.busline;
...
public class BuslineActivity extends Activity implements OnMarkerClickListener,
	...
	protected void onCreate(Bundle bundle) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.busline_activity);
        /*
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
	...
	private void init() {
		...
		Button searchByName = (Button) findViewById(com.zxb.xmap.remote.R.id.searchbyname);
		searchByName.setOnClickListener(this);
		selectCity = (Spinner) findViewById(com.zxb.xmap.remote.R.id.cityName);
		...
		searchName = (EditText) findViewById(com.zxb.xmap.remote.R.id.busName);
	}
	...
	class BusLineDialog extends Dialog implements OnClickListener {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(com.zxb.xmap.remote.R.layout.busline_dialog);
			preButton = (Button) findViewById(com.zxb.xmap.remote.R.id.preButton);
			nextButton = (Button) findViewById(com.zxb.xmap.remote.R.id.nextButton);
			listView = (ListView) findViewById(com.zxb.xmap.remote.R.id.listview);
	...
	public void onBusLineSearched(BusLineResult result, int rCode) {
		...
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getQuery() != null
				...
				ToastUtil.show(BuslineActivity.this, com.zxb.xmap.remote.R.string.no_result);
			}
		} else {
