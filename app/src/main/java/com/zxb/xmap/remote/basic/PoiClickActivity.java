...
public class PoiClickActivity extends Activity implements OnPOIClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.poiclick_activity);
		mMapView = (MapView) findViewById(com.zxb.xmap.remote.R.id.map);
	...
	public void onPOIClick(Poi poi) {
		...
		textView.setBackgroundResource(com.zxb.xmap.remote.R.drawable.custom_info_bubble);
