...
public class PreviewPhotoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.zxb.xmap.remote.R.layout.preview_photo_activity);
		getIntentData();
		mQueue = Volley.newRequestQueue(this.getApplicationContext());
		mImageLoader = new ImageLoader(mQueue, new AMApCloudImageCache());
		mTitletv = (TextView) findViewById(com.zxb.xmap.remote.R.id.title_des_text);
		mTitletv.getPaint().setFakeBoldText(true);
		mpbLoding = (ProgressBar) findViewById(com.zxb.xmap.remote.R.id.pb_loading);
		mphtoPager = (ViewPager) findViewById(com.zxb.xmap.remote.R.id.viewpager_photo);
		mphtoPager.setOnPageChangeListener(pageChangeListener);
		mButtonback = (Button) findViewById(com.zxb.xmap.remote.R.id.back);
